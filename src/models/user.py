...
def get_telegram_user(telegram_id: int) -> Optional[Row]:
    """
...
def get_user(id: int) -> Optional[Row]:
    """
...
def set_master(id: int, is_master: bool) -> bool:
    """
    ...
    Returns:
        True if successful, False if user not found
    """
    return update_user_field(id, "is_master", int(is_master))
...
def set_admin(id: int, is_admin: bool) -> bool:
    ...
    Returns:
        True if successful, False if user not found
    """
    return update_user_field(id, "is_admin", int(is_admin))
